...
function Login() {
    ...
    // const teacherdetails = JSON.parse(teacher)
    ...
    const handleSubmit = (e) => {
        ...
        fetch(config.baseUrl + "teacherlogin").then((res)=>res.json()).then((data)=>
        {
           const student = data.find((v)=> v.email == email && v.password == password)
           if(student)
            {
                localStorage.setItem("teacherinfo" , JSON.stringify(student))
